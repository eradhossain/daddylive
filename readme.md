...
9. Channels playlist is accessible via: **https://eamovies-live.hf.space/playlist/channels**. (Refresh playlist from your iptv player to update)</br>
   Events playlist is accessible via: **https://eamovies-live.hf.space/playlist/events**. (Refresh playlist from your iptv player to update)
10. Enjoy! </br>
